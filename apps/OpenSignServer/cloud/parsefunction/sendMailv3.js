...
async function sendMailProvider(req) {
  ...
  // Upstream OpenSign appended a "file a complaint with OpenSign™" footer
  // pointing at complaints@opensignlabs.com to every email — removed (we're
  // not OpenSign Labs and have no such complaints inbox).
  const reportMsg = '';
