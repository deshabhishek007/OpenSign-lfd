      ...
      <div className="op-navbar bg-base-100 shadow touch-none">
        ...
        <div className="flex-1 ml-2">
          <div
            ...
            className="cursor-pointer select-none text-xl md:text-2xl font-extrabold tracking-tight leading-none"
            aria-label="LDF Sign"
          >
            <span className="text-primary">LDF</span>{" "}
            <span className="text-base-content">Sign</span>
          </div>
        </div>
